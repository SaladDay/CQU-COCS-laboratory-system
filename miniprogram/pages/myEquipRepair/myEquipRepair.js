...
Page({
    ...
    goToPubish:function(e){
        wx.redirectTo({
            url:'/pages/equipRepair/equipRepair'
        })
    },
    escUp:function(e){
        wx.redirectTo({
    ...
    refresh: async function(){
        ...
        var data  =  {
            type: 'myEquipRepairManager',
            opt: 'findAllEquipRepairByUserId',
            _id:this.data.loginOpenId
          }
        var resp = await app.requestCloud(data);
    ...
    onLoad:function (options) {
        ...
        this.data.loginOpenId = app.globalData.userInfo.openId;
    },
